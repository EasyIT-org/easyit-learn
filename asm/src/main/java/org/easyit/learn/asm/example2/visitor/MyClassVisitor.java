...
public class MyClassVisitor extends ClassVisitor {
     ...
     *
     * @param source the name of the source file from which the class was compiled. May be {@literal null}.
     * @param debug  additional debug information to compute the correspondence between source and compiled elements of
     *               the class. May be {@literal null}.
     */
    public void visitSource(final String source, final String debug) {
        record("visitSource", new Object[] {
            source,
            debug
        });
    }
     ...
     * @param access  the module access flags, among {@code ACC_OPEN}, {@code ACC_SYNTHETIC} and {@code ACC_MANDATED}.
     * @param version the module version, or {@literal null}.
     * @return a visitor to visit the module values, or {@literal null} if this visitor is not interested in visiting
     * this module.
     */
    public ModuleVisitor visitModule(final String name, final int access, final String version) {
        record("visitModule", new Object[] {
            name,
            access,
            version
        });
    ...
    /**
     * Visits the nest host class of the class. A nest is a set of classes of the same package that share access to
     * their private members. One of these classes, called the host, lists the other members of the nest, which in turn
     * should link to the host of their nest. This method must be called only once and only if the visited class is a
     * non-host member of a nest. A class is implicitly its own nest, so it's invalid to call this method with the
    ...
    public void visitNestHost(final String nestHost) {
        record("visitNestHost", new Object[] {nestHost});
    }

    /**
     * Visits the enclosing class of the class. This method must be called only if this class is a local or anonymous
     * class. See the JVMS 4.7.7 section for more details.
     *
    ...
    public void visitOuterClass(final String owner, final String name, final String descriptor) {
        record("visitOuterClass", new Object[] {
            owner,
            name,
            descriptor
        });
    ...
    /**
     * Visits a member of the nest. A nest is a set of classes of the same package that share access to their private
     * members. One of these classes, called the host, lists the other members of the nest, which in turn should link to
     * the host of their nest. This method must be called only if the visited class is the host of a nest. A nest host
     * is implicitly a member of its own nest, so it's invalid to call this method with the visited class name as
     * argument.
     *
     * @param nestMember the internal name of a nest member (see {@link Type#getInternalName()}).
     */
    public void visitNestMember(final String nestMember) {
        record("visitNestMember", new Object[] {nestMember});
    }
    ...
    public void visitPermittedSubclass(final String permittedSubclass) {
        record("visitPermittedSubclass", new Object[] {permittedSubclass});
    }

    /**
     * Visits information about an inner class. This inner class is not necessarily a member of the class being visited.
     * More precisely, every class or interface C which is referenced by this class and which is not a package member
     * must be visited with this method. This class must reference its nested class or interface members, and its
    ...
    public void visitInnerClass(
        ...
        record("visitInnerClass", new Object[] {
            name,
            outerName,
            innerName,
            access
     ...
     *                   use generic types.
     * @return a visitor to visit this record component annotations and attributes, or {@literal null} if this class
     * visitor is not interested in visiting these annotations and attributes.
     */
    public RecordComponentVisitor visitRecordComponent(
        final String name, final String descriptor, final String signature) {
        record("visitRecordComponent", new Object[] {
            name,
            descriptor,
            signature
        });
     ...
     * @return a visitor to visit field annotations and attributes, or {@literal null} if this class visitor is not
     ...
     * {@literal null}) each time it is called, i.e., it should not return a previously returned visitor.
     *
     ...
     *                   be {@literal null}.
     * @return an object to visit the byte code of the method, or {@literal null} if this class visitor is not
    ...
    public void printUnVisitedMethod() {
